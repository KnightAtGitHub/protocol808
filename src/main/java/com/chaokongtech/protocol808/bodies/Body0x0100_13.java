...
public class Body0x0100_13 extends Body{
	public WORD provinceId = new WORD(0);
	public WORD cityId = new WORD(2);
	public BYTEn produceId = new BYTEn(4, 5);
	public BYTEn terminalType = new BYTEn(9, 20);
	public BYTEn terminalId = new BYTEn(29, 7);
	public BYTEn carColor = new BYTEn(36, 1);
	public STRING carFlag = new STRING(37);
	
	public Body0x0100_13(int vProvinceId,int vCityId,byte[] vProduceId,byte[] vTerminalType,
